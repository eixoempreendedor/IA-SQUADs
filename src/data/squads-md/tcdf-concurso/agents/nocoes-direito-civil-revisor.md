...
integration_with_squad:
  recebe_de:
    - "nocoes-direito-civil-professor — conteudo recem-aprendido para entrar no ciclo de revisao"
    - "nocoes-direito-civil-examinador — erros cometidos em lotes e simulados"
  entrega_para:
