...
Checklist:
  ...
  - "[ ] Bruto e liquido apurados por grupo e por topico"
...
3. Apurar **bruto e liquido por grupo**.
4. **Grupo >= 90% bruto** (somados os seus topicos): mantem no pool.
5. **Grupo < 90% bruto em 2 domingos seguidos** ou **< 80% bruto em um domingo**: REGRIDE inteiro para o Nivel 2 e reentra no seu dia da semana.
...
O indice do Nivel 3 e o melhor preditor que voce tem — e e o **liquido** dele que projeta a nota. Compare sempre com os minimos reais: P1 >= 7,00 · P2 >= 13,00 · P3 >= 21,00 · conjunto >= 45,00. Um pool com 90% bruto mas concentrado em grupos leves nao diz muito sobre a prova — o `mentor-desempenho` aponta essa distorcao.
