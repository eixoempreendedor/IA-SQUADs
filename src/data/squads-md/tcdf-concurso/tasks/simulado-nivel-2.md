...
5. **>= 90%**: grupo VENCIDO — todos os seus topicos entram no pool do Nivel 3; o dia passa a rodar manutencao quinzenal e o tempo liberado vai para os grupos ainda pendentes.
6. **< 90%**: repete no mesmo dia da semana seguinte. Os topicos com pior liquido recebem revisao dirigida com o `<materia>-revisor` e novos lotes de Nivel 1.
