...
| Materia | # | Topico | Peso | Status | Melhor lote |
|---|---|---|---|---|---|
| Direito Constitucional | 1 | Constituição da República Federativa do Brasil de 1988: 1.1 princíp... | 1 | — |  |
...
| Direito Constitucional | 9 | Funções essenciais à justiça: 9.1 Ministério Público; 9.2 advocacia... | 1 | — |  |
| Lei Orgânica do TCDF e Regimento Interno | 1 | Lei Orgânica do TCDF: 1.1 natureza, competência e jurisdição; 1.2 c... | 5 | — |  |
| Lei Orgânica do TCDF e Regimento Interno | 2 | Regimento Interno do TCDF: 2.1 Resolução nº 296/2016, títulos I, II... | 5 | — |  |
...
| Materia | # | Topico | Peso | Status | Melhor lote |
|---|---|---|---|---|---|
| Administração Geral e Pública | 1 | Evolução da administração: 1.1 perspectiva clássica (administração... | 2 | — |  |
| Administração Geral e Pública | 2 | Evolução da administração do setor público brasileiro: 2.1 estrutur... | 1 | — |  |
| Administração Geral e Pública | 3 | Administração pública patrimonialista: 3.1 administração pública bu... | 2 | — |  |
| Administração Geral e Pública | 4 | Governança: 4.1 princípios da governança pública (capacidade de res... | 3 | — |  |
| Administração Geral e Pública | 5 | Funções administrativas: planejamento, organização, direção e controle | 1 | — |  |
| Administração Geral e Pública | 6 | Ferramentas da administração: 6.1 análise SWOT; 6.2 matriz GUT; 6.3... | 2 | — |  |
| Administração Geral e Pública | 7 | Modelagem de processos: 7.1 propósito da modelagem de processos; 7.... | 2 | — |  |
| Administração Geral e Pública | 8 | Gestão de pessoas por competências: 8.1 conhecimentos, habilidades... | 1 | — |  |
| Administração Geral e Pública | 9 | Gestão de projetos e portfólios: 9.1 padrões de referência em geren... | 1 | — |  |
| Análise de Dados, Noções de Estatística e Inteligência Artificial | 1 | Fundamentos de análise de dados: 1.1 tipos de dados (estruturados e... | 1 | — |  |
| Análise de Dados, Noções de Estatística e Inteligência Artificial | 2 | Estatística descritiva e análise exploratória de dados: 2.1 tabelas... | 1 | — |  |
...
| Materia | # | Topico | Peso | Status | Melhor lote |
|---|---|---|---|---|---|
| Regime Jurídico dos Servidores Públicos Civis do DF (LC 840/2011) | 1 | Lei Complementar nº 840/2011 (regime jurídico dos servidores públic... | 8 | — |  |
| Direito Previdenciário | 1 | Seguridade social: 1.1 origem e evolução legislativa no Brasil; 1.2... | 1 | — |  |
| Direito Previdenciário | 2 | Regime geral da previdência social – RGPS: Lei federal nº 8.212/199... | 2 | — |  |
| Direito Previdenciário | 3 | Regime próprio de previdência social dos servidores públicos – RPPS | 2 | — |  |
| Direito Previdenciário | 4 | Regime Próprio de Previdência Social do Distrito Federal – RPPS/DF:... | 2 | — |  |
| Direito Previdenciário | 5 | Previdência complementar: Lei Complementar federal nº 108/2001, Lei... | 1 | — |  |
...
| Língua Portuguesa | 4 | Domínio dos mecanismos de coesão textual: 4.1 emprego de elementos... | 2 | — |  |
| Língua Portuguesa | 5 | Domínio da estrutura morfossintática do período: 5.1 emprego das cl... | 3 | — |  |
| Língua Portuguesa | 6 | Reescrita de frases e parágrafos do texto: 6.1 significação das pal... | 2 | — |  |
...
| Noções de Primeiros Socorros | 1 | Cuidados iniciais com a vítima, reconhecimento de situações de urgê... | 3 | — |  |
