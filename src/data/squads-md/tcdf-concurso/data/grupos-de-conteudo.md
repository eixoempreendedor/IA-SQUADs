...
| **2 — Grupo de conteudo** | Um dos 6 grupos de conteúdo (conjunto de tópicos de matérias diferentes que se estudam juntos) | 50 | Manha do dia fixo do grupo, antes de qualquer conteudo novo | 90% | Grupo marcado como VENCIDO e incluido no pool do Nivel 3; o dia passa a rodar manutencao quinzenal |
...
| Materia | # | Topico | Peso |
|---|---|---|---|
| Direito Constitucional | 1 | Constituição da República Federativa do Brasil de 1988: 1.1 princípios fundamentais | 1 |
...
| Direito Constitucional | 9 | Funções essenciais à justiça: 9.1 Ministério Público; 9.2 advocacia pública; 9.3 Defensoria Pública | 1 |
| Lei Orgânica do TCDF e Regimento Interno | 1 | Lei Orgânica do TCDF: 1.1 natureza, competência e jurisdição; 1.2 composição; 1.3 Plenário e câmaras; 1.4 presidente,... | 5 |
| Lei Orgânica do TCDF e Regimento Interno | 2 | Regimento Interno do TCDF: 2.1 Resolução nº 296/2016, títulos I, II e III (art. 1º a 116) | 5 |
...
| Materia | # | Topico | Peso |
|---|---|---|---|
| Administração Geral e Pública | 1 | Evolução da administração: 1.1 perspectiva clássica (administração científica, organizações burocráticas); 1.2 perspe... | 2 |
| Administração Geral e Pública | 2 | Evolução da administração do setor público brasileiro: 2.1 estrutura organizacional do Estado: três poderes; 2.2 form... | 1 |
| Administração Geral e Pública | 3 | Administração pública patrimonialista: 3.1 administração pública burocrática; 3.2 administração pública gerencial | 2 |
| Administração Geral e Pública | 4 | Governança: 4.1 princípios da governança pública (capacidade de resposta, integridade, confiabilidade, melhoria regul... | 3 |
| Administração Geral e Pública | 5 | Funções administrativas: planejamento, organização, direção e controle | 1 |
| Administração Geral e Pública | 6 | Ferramentas da administração: 6.1 análise SWOT; 6.2 matriz GUT; 6.3 5W2H; 6.4 ciclo PDCA; 6.5 mapas estratégicos; 6.6... | 2 |
| Administração Geral e Pública | 7 | Modelagem de processos: 7.1 propósito da modelagem de processos; 7.2 notações: BPMN, cadeia de processos orientada a... | 2 |
| Administração Geral e Pública | 8 | Gestão de pessoas por competências: 8.1 conhecimentos, habilidades e atitudes (CHA); 8.2 matriz de competência; 8.3 a... | 1 |
| Administração Geral e Pública | 9 | Gestão de projetos e portfólios: 9.1 padrões de referência em gerenciamento de projetos (PMBOK, Prince, Scrum e métod... | 1 |
| Análise de Dados, Noções de Estatística e Inteligência Artificial | 1 | Fundamentos de análise de dados: 1.1 tipos de dados (estruturados e não estruturados; quantitativos e qualitativos);... | 1 |
| Análise de Dados, Noções de Estatística e Inteligência Artificial | 2 | Estatística descritiva e análise exploratória de dados: 2.1 tabelas de distribuição de frequências, medidas de tendên... | 1 |
...
| Materia | # | Topico | Peso |
|---|---|---|---|
| Regime Jurídico dos Servidores Públicos Civis do DF (LC 840/2011) | 1 | Lei Complementar nº 840/2011 (regime jurídico dos servidores públicos civis do Distrito Federal, das autarquias e das... | 8 |
| Direito Previdenciário | 1 | Seguridade social: 1.1 origem e evolução legislativa no Brasil; 1.2 conceito, organização e princípios constitucionais | 1 |
| Direito Previdenciário | 2 | Regime geral da previdência social – RGPS: Lei federal nº 8.212/1991 e Lei federal nº 8.213/1991 | 2 |
| Direito Previdenciário | 3 | Regime próprio de previdência social dos servidores públicos – RPPS | 2 |
| Direito Previdenciário | 4 | Regime Próprio de Previdência Social do Distrito Federal – RPPS/DF: Lei Complementar distrital nº 769/2008 | 2 |
| Direito Previdenciário | 5 | Previdência complementar: Lei Complementar federal nº 108/2001, Lei Complementar federal nº 109/2001 e Lei Complement... | 1 |
| Noções de Direito Civil | 1 | Lei de Introdução às Normas do Direito Brasileiro | 1 |
| Noções de Direito Civil | 2 | Pessoas: 2.1 pessoas naturais; 2.2 pessoas jurídicas; 2.3 domicílio | 1 |
| Noções de Direito Civil | 3 | Bens | 1 |
...
| Materia | # | Topico | Peso |
|---|---|---|---|
| Língua Portuguesa | 1 | Compreensão e interpretação de textos de gêneros variados | 3 |
| Língua Portuguesa | 2 | Reconhecimento de tipos e gêneros textuais | 1 |
| Língua Portuguesa | 3 | Domínio da ortografia oficial | 1 |
| Língua Portuguesa | 4 | Domínio dos mecanismos de coesão textual: 4.1 emprego de elementos de referenciação, substituição e repetição, de con... | 2 |
| Língua Portuguesa | 5 | Domínio da estrutura morfossintática do período: 5.1 emprego das classes de palavras; 5.2 relações de coordenação ent... | 3 |
| Língua Portuguesa | 6 | Reescrita de frases e parágrafos do texto: 6.1 significação das palavras; 6.2 substituição de palavras ou de trechos... | 2 |
| Raciocínio Lógico e Matemática Financeira | 1 | Estruturas lógicas | 1 |
...
| Conhecimentos do Distrito Federal e Política para Mulheres | 2 | Plano Distrital de Política para Mulheres (2020–2023) | 1 |
| Conhecimentos do Distrito Federal e Política para Mulheres | 3 | Lei Federal nº 11.340/2006 – Lei Maria da Penha | 1 |
| Noções de Primeiros Socorros | 1 | Cuidados iniciais com a vítima, reconhecimento de situações de urgência e emergência, acionamento do socorro especial... | 3 |
...
Tempo-alvo: **Nivel 1** 20 questoes em ate 30 minutos · **Nivel 2** 50 questoes em ate 70 minutos · **Nivel 3** 200 questoes em ate 4 horas (ritmo real de prova)
