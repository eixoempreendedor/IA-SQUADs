...
Em [`pdf/materias/`](pdf/materias/), um PDF por materia (16 no total). Cada topico e cada subtopico do edital em uma linha, com a aula do curso ao lado e oito colunas de bolinhas. O nome de cada filtro montado no Gran e escrito em pe no cabecalho da coluna; as bolinhas marcadas dizem o que aquele filtro sorteia. No pe das mesmas colunas entra o resultado do ultimo lote de cada filtro, e abaixo o registro corrido (filtro, data, total, acertos, erros, bruto e liquido).
